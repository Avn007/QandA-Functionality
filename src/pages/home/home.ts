...
export class HomePage {
  ...
  questionList$: Observable<Item2[]>;
  answerList$: Observable<Item3[]>;

  constructor(public navCtrl: NavController, public alert: AlertController, private crudservice: CRUDService) {
